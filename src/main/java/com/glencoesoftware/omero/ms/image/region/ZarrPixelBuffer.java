...
public class ZarrPixelBuffer implements PixelBuffer {
    ...
    public PixelData getTile(Integer z, Integer c, Integer t, Integer x, Integer y, Integer w, Integer h)
        ...
        return zarrUtils.getPixelData(
                ...
                resolutionLevel, domStrBuf.toString(), opWellSample);
    }
    ...
    public int getSizeX() {
        return zarrUtils.getDimSize(
                ngffDir, filesetId, pixels.getImage().getSeries(),
                resolutionLevel, 4, opWellSample);
    }
    ...
    public int getSizeY() {
        return zarrUtils.getDimSize(
                ngffDir, filesetId, pixels.getImage().getSeries(),
                resolutionLevel, 3, opWellSample);
    }
    ...
    public int getSizeZ() {
        return zarrUtils.getDimSize(
                ngffDir, filesetId, pixels.getImage().getSeries(),
                resolutionLevel, 2, opWellSample);
    }
    ...
    public int getSizeC() {
        return zarrUtils.getDimSize(
                ngffDir, filesetId, pixels.getImage().getSeries(),
                resolutionLevel, 1, opWellSample);
    }
    ...
    public int getSizeT() {
        return zarrUtils.getDimSize(
                ngffDir, filesetId, pixels.getImage().getSeries(),
                resolutionLevel, 0, opWellSample);
    }
